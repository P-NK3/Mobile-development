        ...
        callForecast.enqueue(new Callback<WeatherForecast>() {
            ...
            public void onResponse(Call<WeatherForecast> call, Response<WeatherForecast> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    ActionBar.LayoutParams paramsTextView = new ActionBar.LayoutParams (
                            ActionBar.LayoutParams.WRAP_CONTENT, ActionBar.LayoutParams.WRAP_CONTENT);
                    ActionBar.LayoutParams paramsImageView = new ActionBar.LayoutParams (convertDPtoPX(40, MainActivity.this),
                            convertDPtoPX(40, MainActivity.this));

                    int marginRight = convertDPtoPX(15, MainActivity.this);
                    ActionBar.LayoutParams paramsLinearLayout = new ActionBar.LayoutParams (ActionBar.LayoutParams.WRAP_CONTENT,
